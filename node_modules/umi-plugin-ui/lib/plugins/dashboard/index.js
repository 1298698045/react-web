    ...
    var _ref2 = _asyncToGenerator(function* ({
      ...
      switch (type) {
        ...
        case 'org.umi.dashboard.zaobao.list':
          {
            try {
              const _ref3 = yield (0, _got().default)('https://unpkg.com/umi-ui-rss/data/index.json'),
        ...
        case 'org.umi.dashboard.zaobao.list.detail':
          {
            ...
            const _ref4 = yield (0, _got().default)(`https://unpkg.com/umi-ui-rss/data/detail/${id}.json`),
