...
var ConfigAction = function ConfigAction(props) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(_antd.Button, {
    size: api.mini ? 'small' : 'default',
    onClick: handleSetting
  }, React.createElement(_icons.SettingOutlined, null)), React.createElement(_setting.default, {
    ref: drawerRef
  }));
};
