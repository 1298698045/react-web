...
var DailyReport = function DailyReport(props) {
  ...
  var _React$useContext = React.useContext(_context3.default),
      api = _React$useContext.api;

  var _ = api._,
      event = api.event;
  var formatMessage = api.intl.formatMessage;
  ...
  var _useSWR = (0, _swr.default)('zaobao.list', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _ref2, data;
  ...
  var _useSWR2 = (0, _swr.default)(function () {
    return "zaobao.list.detail.".concat(currentId);
  }, /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              id = Number(query.replace('zaobao.list.detail.', ''));
  ...
  var LoadMore = size < length && React.createElement("div", {
    style: {
      textAlign: 'center',
      marginTop: 12,
      height: 32,
  ...
  return React.createElement(_antd.List, {
    ...
    renderItem: function renderItem(item) {
      return _.isPlainObject(item) && React.createElement(_antd.List.Item, {
        ...
        title: React.createElement("a", {
          ...
          ellipsis: true
        }, item.title), ' ', React.createElement(_antd.Tag, {
