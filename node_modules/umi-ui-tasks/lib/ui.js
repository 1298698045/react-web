...
var _default = function _default(api) {
  ...
  var Terminal = function Terminal(props) {
    return _react.default.createElement(ApiTerminal, _extends({
        ...
        return {
          ...
          component: function component() {
            return _react.default.createElement("div", {
              ...
              dbPath: dbPath,
              Terminal: Terminal,
              namespace: _model.default.namespace
            }));
          }
        };
      })
  ...
  var commonContent = [_react.default.createElement("a", {
  ...
  api.addDashboard({
    ...
    commonContent : [_react.default.createElement("a", {
      onClick: function onClick() {
