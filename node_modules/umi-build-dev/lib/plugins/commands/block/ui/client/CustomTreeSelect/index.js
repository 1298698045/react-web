...
var CustomTreeSelect = function CustomTreeSelect(props) {
  ...
  var selectDom = _react.default.createElement(_antd.TreeSelect, _extends({
    showSearch: true,
    style: {
  ...
  }, onlySelectLeaf ? selectDom : _react.default.createElement(InputGroup, {
    compact: true
  }, selectDom, _react.default.createElement(_antd.Input, {
    style: {
      width: '70%'
    },
    value: name,
