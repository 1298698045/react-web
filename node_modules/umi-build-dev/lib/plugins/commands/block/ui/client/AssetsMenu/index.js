...
var _default = function _default(props) {
  ...
  function renderResources() {
    ...
    return matchedResources.map(function (r) {
      ...
      }, r.name), _react.default.createElement("div", {
        className: _indexModule.default.description
      }, r.description)), _react.default.createElement("div", {
        className: _indexModule.default.switcher
      }, isCurrent ? _react.default.createElement(_icons.UpOutlined, {
        style: {
          fontSize: '12px'
        }
  ...
  return _react.default.createElement(_react.default.Fragment, null, renderResources());
};
