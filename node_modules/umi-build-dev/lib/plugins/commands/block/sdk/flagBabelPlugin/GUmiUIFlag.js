...
var GUmiUIFlag = /*#__PURE__*/function (_React$Component) {
  _inherits(GUmiUIFlag, _React$Component);

  function GUmiUIFlag(props) {
    var _this;

    _classCallCheck(this, GUmiUIFlag);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(GUmiUIFlag).call(this, props));
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
        ...
        style: _objectSpread({}, inline ? {
          ...
          transition: 'all .3s',
          overflow: 'hidden',
          fontFamily: 'Chinese Quote,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,sans-serif'
        }),
