...
import findRoute, {
  getUrlQuery,
} from '/Users/zhaodong/Desktop/myDemo/reactProject/aplus_bss_dev/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/zhaodong/Desktop/myDemo/reactProject/aplus_bss_dev',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
