...
const WeekdayEditModal = props => {
	...
	return (
		<Modal
			destroyOnClose
			title={( selectedRow[ FIELDS.SYSTEM.DICT.KEY.key ] ? '修改' : '新增' ) + FIELDS.SYSTEM.WEEKDAY.MEMO.title}
			width={350}
			visible={visible}
			onOk={onOk}
			onCancel={onCancel}
...
export default Form.create()( WeekdayEditModal );
