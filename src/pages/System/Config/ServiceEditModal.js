...
const ServiceEditModal = props => {
	...
	return (
		<Modal
			destroyOnClose
			title={( selectedRow[ FIELDS.SYSTEM.SERVICE.TEL.key ] ? '修改' : '设置' ) + '客服电话设置'}
			width={350}
			visible={visible}
			onOk={onOk}
			onCancel={onCancel}
				...
				<Row gutter={24}>
					{
						[
							...
							FIELDS.SYSTEM.SERVICE.ON_TIME,
							FIELDS.SYSTEM.SERVICE.OFF_TIME,
						].map( v =>
...
export default Form.create()( ServiceEditModal );
