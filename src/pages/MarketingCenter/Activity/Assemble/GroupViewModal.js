...
const GroupViewModal = props => {
	...
	// 表格-字段
	let tableColumns = [...FIELDS.ACTIVITY.ASSEMBLE_GROUP_TABLE_HEAD]
	...
	tableColumns.push({
		...
		customRender: ( text, record, ) => {
			...
			return [
				...
				: <Text key="hexiao" disabled>核销</Text>,
			]
		}
	})
	...
	return (
		<Modal
			width="80%"
			title={typeof selectItem.configId === 'undefined' ? '活动核销' : "参团详情"}
			visible={visible}
