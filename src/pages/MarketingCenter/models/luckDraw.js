import { updActivity, queryOpenGroupList, getActivityInfoById, queryActivityPageList, updAcitivityStatus, saveActivity, activityAdjust  } from '@/services/activity';
...
export default {
	...
	effects: {
		...
		* saveActivity ( { payload }, { call, } ){
			...
			return responseA( yield call( saveActivity, payload ) )()('保存成功！', '' );
		},
		* updActivity ( { payload }, { call, } ){
			const requestParams = transformRequestParams( { ...payload } );
			return responseA( yield call( updActivity, payload ) )()('修改成功！', '' );
		},
		* updAcitivityStatus ( { params, actionName }, { call, } ){
			return responseA( yield call( updAcitivityStatus, params ) )()( `${actionName}成功`, '' );
		},
		* activityAdjust ( { payload }, { call, } ){			
			return responseA( yield call( activityAdjust, payload ))()( '调整成功', '' );
		},
		* getActivityInfo ( { payload }, { call, } ){
			return responseA( yield call( getActivityInfoById,  payload ) )()();
		}
	},
	reducers: {
		save ( state, action ){
