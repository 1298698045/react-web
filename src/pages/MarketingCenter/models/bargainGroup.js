import { queryBargainVerificationList, closeBargain  } from '@/services/activity';
...
export default {
	...
	effects: {
		* fetch ( { payload }, { call, put } ){
			const res = responseA( yield call( queryBargainVerificationList, requestA({
				...payload
			})))( 'item' )();
			if ( res ) {
				yield put( {
