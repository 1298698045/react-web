import { doGetFinanceChargeSignUpList, doPrintReceipt, doExportList, } from '@/services/api';
import createInitialModelState from '@/utils/createInitialModelState';
import response from '@/services/response';

const name = 'financeIncomeSignUpList';
...
export default {
	...
	effects: {
		...
		* exportList ( { payload, }, { call, } ){
			return yield call( doExportList, { params: payload } );
		},
	},
